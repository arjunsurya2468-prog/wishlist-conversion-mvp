...
export default function ReviewsSection({ activeConcern, setActiveConcern, onViewAll, product }) {
  ...
  const reviews = [
    { size: 'L', date: 'Apr 14, 2026', text: "It's best product and also under budget 👌 👏 😀 and I am very satisfying after buy this product", author: 'Verified Buyer', rating: '5' },
    { size: 'M', date: 'Jun 21, 2026', text: "Worth vermarking product for this humid weather...", author: 'Verified Buyer', rating: '5' },
  ];
