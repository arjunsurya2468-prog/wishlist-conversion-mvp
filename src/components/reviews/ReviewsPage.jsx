...
export default function ReviewsPage({ activeConcern, setActiveConcern, onBack }) {
  ...
  const reviews = [
    { id: 1, rating: 5, date: 'Apr 14, 2026', text: "It's best product and also under budget 👌 👏 😀 and I am very satisfying after buy this product", author: 'Verified Buyer', size: 'L', concerns: ['Fit', 'Quality'], helpfulCount: 12 },
    { id: 2, rating: 5, date: 'Jun 21, 2026', text: "Worth vermarking product for this humid weather...", author: 'Verified Buyer', size: 'M', concerns: ['Fit'], helpfulCount: 8 },
    { id: 3, rating: 4, date: 'Mar 12, 2026', text: "Good material but sleeves are a bit long.", author: 'Verified Buyer', size: 'XL', concerns: ['Fit', 'Quality'], helpfulCount: 4 },
    { id: 4, rating: 4, date: 'Jan 05, 2026', text: "Nice tshirt, color didn't fade after washing.", author: 'Verified Buyer', size: 'L', concerns: ['Quality'], helpfulCount: 2 },
    { id: 5, rating: 3, date: 'Feb 18, 2026', text: "Average product, fit is slightly tighter than expected.", author: 'Verified Buyer', size: 'S', concerns: ['Fit'], helpfulCount: 0 },
    { id: 6, rating: 2, date: 'May 30, 2026', text: "Stitching came off after one wash.", author: 'Verified Buyer', size: 'XXL', concerns: ['Quality'], helpfulCount: 1 },
    { id: 7, rating: 4, date: 'Aug 10, 2026', text: "Overall satisfied, looks exactly like the picture.", author: 'Verified Buyer', size: 'M', concerns: [], helpfulCount: 0 },
  ];
